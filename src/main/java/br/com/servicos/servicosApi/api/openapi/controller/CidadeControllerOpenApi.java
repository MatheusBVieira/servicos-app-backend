...
public interface CidadeControllerOpenApi {
	...
	List<CidadeResponse> listar(@ApiParam(value = "Deve passar paginação caso queira alterar a padrão", example = "Representação de uma paginação") Pageable paginacao);
